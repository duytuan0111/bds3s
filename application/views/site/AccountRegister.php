...
<head>
    <title>Trang chọn tài khoản đăng ký</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="wrapper_all dangy_dangnhap login_dangky">
        <div class="main_tt">
            <div class="account account_Respon d_flex align_c flex_column">
                <div class="account_p account_p-Respon ">
                    ...
                    <div class="account_choose-text font_s14 m_t_b_24 text_c">Chọn loại tài khoản để đăng ký</div>
                    <a href="trang-dang-ky-nguoi-mua-thue.html">
                    ...
                    <a href="/trang-dang-ky-nha-moi-gioi.html">
                    ...
                    <a href="trang-dang-ky-nguoi-ban-cho-thue.html">
                        <div class="account_box d_flex bg_green mr_t_16 align_c">
                            <div class="account_box-w-h">
                                <div class="account_box-icon">
                    ...
                    <a href="trang-dang-ky-doanh-nghiep.html">
                        <div class="account_box d_flex bg_green mr_t_16">
                            <div class="account_box-w-h">
                                <div class="account_box-icon">
