                        ...
                        <div class="result_news flex_1 pd_l_24">
                            <div class="managent_menu bg_white pd_16 hidden">
                                ...
                                <div class="d_flex align_c mt_16 managent_menu_list">
                                    ...
                                    <div class="h_40 bg_gray click_kh cursor_p click_kh_diem acive_mnc1_mb" onclick="location.href='khach-hang-tu-diem.html'">
                            ...
                            <div class="main_table_list_all position_r mt_24 table_person table_transaction fz15 ">
                                ...
                                <div class="box_main_table_list position_r wallet activeTableView">
                                    <table class="table" id="scroll_tb">
                                        ...
                                        <tbody>
                                            <?php $i=1;foreach ($CustomerFromPoints as $rows) : ?>
                                                <tr>
                                                    <td class="stt"><?= $i ?></td>
                                                    <td>
                                                        <div class="d_flex align_c">
                                                            ...
                                                            <span class="font_s15 line_h24 font_w400 black_md"><?= $rows['name'] ?></span>
                                                    ...
                                                    <td>
                                                        <span class="block"><?= $rows['phone'] ?></span>
                                                        <span class="block mt_8"><?= $rows['email'] ?></span>
                                                    </td>
                                                    <td><?= $newType[$rows['newTypeInterest']] ?></td>
                                                    <td>
                                                        <span class="block"><?= date('H:i',$rows['time_cr']) ?></span>
                                                        <span class="block mt_8"><?= date('d/m/y',$rows['time_cr']) ?></span>
                                                    </td>
                                                </tr>
                                            <?php $i++;endforeach; ?>
                                        </tbody>
...
function search()
{
    var link = "/khach-hang-tu-diem.html";
