<header id="header">
    <div class="header_content_1 flex justify_content_sb">
        <div class="logo_and_menu flex align_ct">
            <div class="icon_menu">
                <img src="<? echo base_url() ?>assets/images/img_du_an/menu.png" alt="">
            </div>
            <a href="/" class="header_content_logo  cursor_pointer">
                <img src="<? echo base_url() ?>assets/images/img_du_an/svg_logo.svg" alt="">
            </a>
            <div class="timkiem_375 click_show_timkiem_375 show_timkiem">
                <img src="<? echo base_url() ?>assets/images/img_du_an/timkiem_375.png" alt="">
            </div>
        </div>

        <div class="header_content_khung_timkiem flex">
            <div class="header_content_khung_select">
                <select name="" id="" class="select_option select font_size16 cursor_pointer">
            ...
            <div class="header_content_khung_search">
                <input class="input font_size16" type="text" placeholder="Từ khóa tìm kiếm" name="">
                <div class="header_content_khung_icon_search cursor_pointer">
                    <img src="<? echo base_url() ?>assets/images/img_du_an/header_search.svg" alt="">
                </div>
                <div class="text_them_768 cursor_pointer">Đóng</div>
            </div>
        </div>

        <div class="header_content_DTDN flex">
            <!-- NÚT TÌM KIẾM 768 -->
            <div class="timkiem_768 cursor_pointer ">
                <img src="<? echo base_url() ?>assets/images/img_du_an/timkiem_768.png" alt="">
            </div>
            <div class="header_content_DTDN_dangtin flex cursor_pointer">
                <div class="header_content_DTDN_icon_dangtin mr_r11px">
                    <img src="<? echo base_url() ?>assets/images/img_du_an/icon_upnews.svg" alt="">
                </div>
                <a class="dangtin" href="dang-tin-truoc-dang-nhap.html">Đăng tin</a>
            </div>

            <!-- ĐĂNG NHẬP TRƯỚC ĐĂNG NHẬP -->
            <div class="header_login_register_quang">
                <div class="header_content_DTDN_dangnhap">
                    <a class="dangnhap" href="trang-tai-khoan-dang-nhap.html">Đăng nhập</a>
                </div>
                <div class="btn_register_quang">
                    <a href="trang-tai-khoan-dang-ky.html" class="btn_register-a chuxanh_nentrang">
                        Đăng ký
                    </a>
                </div>
            </div>
            <!-- ĐĂNG NHẬP SAU ĐĂNG NHẬP -->
            <div class="header_content_DTDN_dangnhap_thanhcong flex mr_l26px hidden">
                <div class="img_bell cursor_pointer">
                    <img src="<? echo base_url() ?>assets/images/img_du_an/bell.png" alt="">
                </div>
                <div class="img_massage mr_l28px cursor_pointer">
                    <img src="<? echo base_url() ?>assets/images/img_du_an/messenger.png" alt="">
                </div>
                <div class="img_loggin_success mr_l26px cursor_pointer">
    ...
    <div class="header_content_2">
        <ul class="header_content_2_the flex">
            <li class="li1"><a href="https://truyenthongnoibo.timviec365.vn/">Cộng đồng</a></li>
            <li class="li1">
            ...
            <li class="li1">
                ...
                <ul class="du_an_menuC2 mr_t11px">
                    <li class="li2"><a href="">Tính lãi suất vay</a></li>
                    <li class="li2"><a href="">Giá trị ngôi nhà có thể mua</a></li>
                    <li class="li2"><a href="">Nhà biệt thự liền kề</a></li>
                    <li class="li2"><a href="">Mua hay thuê nhà</a></li>
                    <li class="li2"><a href="">So sánh dự án</a></li>
                    <li class="li2"><a href="">Bất động sản gần đây</a></li>
                    <li class="li2"><a href="">Khám phá khu vực</a></li>
                    <li class="li2"><a href="">Giá nhà đất</a></li>
                </ul>
    ...
    <!-- HEADER SELECT -->
    <div class="header_content_3 hidden">
        <div class="header_content_3_sub flex">
            <div class="header_content_3_select">
                <select class="">
            ...
            <div class="header_content_3_select">
                <select class="">
                    ...
                    <option value="">Căn hộ dịch vụ</option>
                    ...
                    <option value="">Cửa hàng, mặt bằng bán lẻ</option>
                    <option value="">Nhà đất , nhà xưởng, kho bãi</option>
        ...
        <div class="popup_menu_padding_ul_li">
            <ul class="popup_menu_padding_ul">
                ...
                <ul class="menu_c2_768 menu_c2_768_tk hidden">
                    <li class="cl_tk"><a href="thiet-ke-nha-dep.html">Nhà đẹp</a></li>
                    <li class="cl_tk"><a href="danh-sach-phong-dep.html">Phòng đẹp</a></li>
                </ul>
                <li class="li_menu"><a href="tin-tuc.html">Tin tức</a></li>
                <li class="li_menu"><a href="tien-ich-lai-suat-vay.html">Tiện ích</a></li>
                <li class="li_menu"><a href="huong-dan-sau-dang-nhap.html">Hướng dẫn</a></li>
            </ul>
        </div>
...
<!-- POPUP TÌM KIẾM -->
<div class="popup_timkiem hidden">
    <div class="popup_timkiem_padding">
        <div class="popup_timkiem_search">
            <div class="popup_timkiem_search_text flex justify_content_sb align_ct">
                <div class="popup_timkiem_search_text1">Tìm kiếm</div>
                <div class="popup_timkiem_search_text1 dong_timkiem">Đóng</div>
            </div>
            <div class="popup_timkiem_search_div flex align_ct justify_content_sb">
                <div class="popup_timkiem_search_div_suv flex align_ct">
                    <div class="popup_timkiem_select">
        ...
        <!-- TỪ KHÓA -->
        <div class="popup_timkiem_tukhoa">
            <div class="popup_timkiem_tukhoa_text1">Từ khóa phổ biến</div>
            <div class="popup_timkiem_tukhoa_text2">
                <div class="timkiem_tukhoa">Mua chung cư vinhome Wespoit W1 tại Hà Nội</div>
                <div class="timkiem_tukhoa">Mua biệt thự tại Ba Vì</div>
                <div class="timkiem_tukhoa">The Sun Avenue</div>
                <div class="timkiem_tukhoa">Mua chung cư vinhome Wespoit W1 tại Hà Nội</div>
                <div class="timkiem_tukhoa">Mua biệt thự tại Ba Vì</div>
                <div class="timkiem_tukhoa">The Sun Avenue</div>
            </div>
        ...
        <!-- NHẬP TỪ KHÓA / NHẬP KÍ TỰ VÀO Ô INPUT SẼ SHOW RA LAYOUT NÀY -->
        <div class="popup_timkiem_nhap_tukhoa hidden">
            <div class="popup_timkiem_nhap_tukhoa_div1">
                <div class="popup_timkiem_tukhoa_text1">Có phải bạn muốn tìm</div>
                <div class="popup_timkiem_nhap_tukhoa_content">
                    <div class="popup_timkiem_nhap_tukhoa_content_text">Chung cư giá rẻ tại Hà Nội</div>
                </div>
                <div class="popup_timkiem_nhap_tukhoa_content">
                    <div class="popup_timkiem_nhap_tukhoa_content_text">Chung cư giá rẻ tại Hà Nội</div>
                </div>
            ...
            <div class="popup_timkiem_nhap_tukhoa_div2">
                <div class="popup_timkiem_tukhoa_text1">Tin đăng gợi ý</div>
                <div class="timkiem_nhap_tukhoa_div2_content">
                    <div class="timkiem_nhap_tukhoa_div2_content_suv">
                        <div class="timkiem_nhap_tukhoa_div2_content_padding flex align_ct">
                            <div class="timkiem_nhap_tukhoa_div2_content_img">
                                <img src="<? echo base_url() ?>assets/images/img_du_an/bacsila.jpg" alt="">
                            </div>
                            <div class="timkiem_nhap_tukhoa_div2_content_text">
                                <div class="timkiem_nhap_tukhoa_div2_content_text1">The Ocean Villas</div>
                                <div class="timkiem_nhap_tukhoa_div2_content_text2 them_mr_b  flex align_ct">
                                    <div class="timkiem_nhap_tukhoa_div2_content_text2_img">
                                        <img src="<? echo base_url() ?>assets/images/img_du_an/address_hi.png" alt="">
                                    </div>
                                    <div class="timkiem_nhap_tukhoa_div2_content_text2_suv">Phường Kim Mã, Quận Ba Đình,
                                        Hà Nội</div>
                                </div>
                                <div class="timkiem_nhap_tukhoa_div2_content_text3 flex align_ct">
                                    <div class="timkiem_nhap_tukhoa_div2_content_text3_suv flex align_ct">
                                        <div class="timkiem_nhap_tukhoa_div2_content_text2_img">
                                            <img src="<? echo base_url() ?>assets/images/img_du_an/icon_money.png" alt="">
                                        </div>
                                        <div class="timkiem_nhap_tukhoa_div2_content_text2_suv color_money">Thỏa thuận
                                        </div>
                                    </div>
                                    <div class="timkiem_nhap_tukhoa_div2_content_text3_suv flex align_ct">
                                        <div class="timkiem_nhap_tukhoa_div2_content_text2_img">
                                        ...
                                        <div class="timkiem_nhap_tukhoa_div2_content_text2_suv">20 - 30 m2</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="border_timkiem"></div>
                    </div>
                    <div class="timkiem_nhap_tukhoa_div2_content_suv">
                        <div class="timkiem_nhap_tukhoa_div2_content_padding flex align_ct">
                            <div class="timkiem_nhap_tukhoa_div2_content_img">
        ...
        <!-- CLICK BỘ LỌC  -->
        <div class="popup_timkiem_boloc hidden">
            <div class="popup_timkiem_tukhoa_text1">Bộ lọc</div>
            <div class="popup_timkiem_boloc_select">
                <div class="popup_timkiem_boloc_select_sub">
                    <select name="" id="" class="select_option js-states form-control">
                ...
                <div class="popup_timkiem_boloc_select_sub">
                    <select placeholder="duy" name="" id="" class="select_option js-states form-control"
                        multiple="multiple">
                        <option value="">Loại bất động sản</option>
            ...
            <div class="popup_timkiem_boloc_btn">Áp dụng</div>
        </div>
    </div>
</div>
<!-- <script>
...
<script>
function active_single_header(menu) {
    document.getElementById(menu).classList.add('gachchan_link');
}
