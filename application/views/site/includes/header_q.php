    ...
    <div class="menu-header nav_bar d_flex space_b align_c position_r ">
        <div class="nav-hd-menu d_flex">
            ...
            <ul class="ul_menu d_flex align_c">
                <li class="li_menu"><a class="font_s16" href="https://truyenthongnoibo.timviec365.vn/">Cộng đồng</a></li>
        ...
        <div class="register d_flex">
            ...
            <div class="header_login_register">
                ...
                <a href="trang-tai-khoan-dang-ky.html" class="btn_register-a-tong" >
                    <div class=" btn_register chuxanh_nentrang">
                        Đăng ký
                    </div>
                </a>
            </div>
