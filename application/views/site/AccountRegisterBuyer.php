            ...
            <div class="account account_nhap account_nhap-mua-thue d_flex flex_column">
                ...
                <div class="account_log-in w_100">
                        ...
                        <div class="khung_input-left_tong w_50">
                            ...
                            <div class="khung_input khung_input-left d_flex align_c">
                                <select name="" id="" class="size-14 select_option">
                                    <option selected="" disabled="" value="" class="" data-select2-id="select2-data-15-7qyn">Loại hình quan tâm *</option>
                            ...
                            <div class="khung_input khung_input-left d_flex align_c">
                                <select name="" id="" class="size-14 select_option">
                                    <option selected="" disabled="" value="" class="" data-select2-id="select2-data-18-dxkk">Loại bất động sản *</option>
                    ...
                    <a href="trang-nhan-ma-otp.html">
                        <div class="mr_t_40 btn_blue bg_green border_none account_log-in_btn account_log-in_dangky"> Đăng ký </div>
                    </a>
                </div>
            </div>
        </div>
