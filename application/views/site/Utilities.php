            ...
            <div class="tien_ich_khoi2">
                ...
                <div class="tien_ich_khoi2_noidung">
                    <div class="khung_tienich">
                        <div class="khung_tienich_heading">Tiện ích</div>
                        <div class="khung_tienich_content flex">
                            <div class="khung_tienich_content_bg">
                                <div class="khung_tienich_content_bg_suv">
                                    ...
                                    <div class="khung_tienich_content_bg_text2">
                                        Công cụ này giúp bạn có những lựa chọn phù hợp, 
                                        nhanh chóng sở hữu ngôi nhà mơ ước
                                    </div>
                                </div>
                            </div>
                            <div class="khung_tienich_content_bg">
                                <div class="khung_tienich_content_bg_suv">
                                    ...
                                    <div class="khung_tienich_content_bg_text2">
                                        Bạn đang thắc mắc dự án nào phù hợp với bạn. 
                                        So sánh dự án sẽ giúp bạn giải quyết vấn đề này.
                                    </div>
                                </div>
                            </div>
                            <div class="khung_tienich_content_bg">
                                <div class="khung_tienich_content_bg_suv">
                                    ...
                                    <div class="khung_tienich_content_bg_text2">
                                        Chia sẻ những bức ảnh và câu chuyện về 1 góc không gian
                                        trong ngôi nhà mà bạn yêu thích
                                    </div>
                                </div>
                            </div>
                            <div class="khung_tienich_content_bg">
                                <div class="khung_tienich_content_bg_suv">
                                    ...
                                    <div class="khung_tienich_content_bg_text2">
                                        Homedy tìm hiểu về vị trí, tiện ích của các quận thành để giúp bạn chọn 
                                        được một bất động sản hoặc khu vực sinh sống hợp lý nhất
                                    </div>
                                </div>
                            </div>
                        </div>
