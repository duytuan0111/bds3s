        ...
        <div class="main_tt">
            <div class="account account_otp qmk_otp d_flex flex_column gachduoi">
                ...
                <div class="account_log-in account_otp-beside w_100 quen_mk_otp">
                    ...
                    <div class="font_s14 m_t_b_24 text_l font_w500 color_grey mr_t_32">Mã xác thực gửi về Email “ABC@gamil.com”</div>
                    <div class="account_otp-beside-otp">
                        <form method="get" class="digit-group digit-group-otp font_s24 d_flex space_b">
                    ...
                    <a href="quen-mat-khau-update-mat-khau.html" class="account_otp-btn btn_blue bg_green border_none account_log-in_btn"> Xác thực </a>
